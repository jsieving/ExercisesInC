/* trout.c and the rest of the code in this project was originally written by
  Allen Downey a while ago.
  It has been modified and slightly refactored by Jane Sieving for Software
  Systems at Olin College.
  */
